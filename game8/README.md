...
game8 已接入共享服务器权威演出层，通过来源—目标轨迹、实体精灵球/卡面移动和中央播报表现拿球、归还、明牌或暗牌保留、捕捉、进化、回合交接与胜负。动画不参与规则结算，快速操作时会自动追赶。

牌堆顶暗保留采用独立私人事件：其他玩家与旁观者只能看到行动者和牌堆等级，真实宝可梦卡面仅发送给持有者。详细事件边界和实机验收项见 [PRESENTATION_MIGRATION.md](PRESENTATION_MIGRATION.md)。
