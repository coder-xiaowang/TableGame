...
const databasePath = process.env.GAME21_DB_PATH || path.resolve(__dirname, ".data/game21.sqlite");
...
import("./server/game-engine.mjs")
  ...
  .catch((error) => {
    console.error("Unable to start authoritative SPYFALL server:", error);
    process.exitCode = 1;
  });
