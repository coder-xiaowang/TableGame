...
const databasePath = process.env.GAME13_DB_PATH || path.resolve(__dirname,".data/game13.sqlite");
...
import("./server/game-engine.mjs")
  ...
  .catch((error)=>{console.error("Unable to start authoritative CABO server:",error);process.exitCode=1;});
