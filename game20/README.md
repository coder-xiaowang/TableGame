...
页面采用“灯下问答沙龙”设计：玩家围绕提问钟盘分布，中央展示当前谜题信号与主持人的回答回声，当前决策表现为桌沿发言卡，私人身份与答案收纳在密封信封中。规则、战绩、公开记录和旁观席位于主桌面下方的独立档案带，不再沿用固定左侧栏。设计依据见 [VISUAL_DESIGN.md](VISUAL_DESIGN.md)。

服务器同时维护独立的公开演出事件流，把主持人回答、猜中、准备、密票提交、平票和结算映射为问答钟盘上的即时场景。演出只表达已发生的权威结果，不参与规则计算；秘密确认匿名、密票不携带票值。事件清单、队列压缩和验收要求见 [PRESENTATION_MIGRATION.md](PRESENTATION_MIGRATION.md)。
